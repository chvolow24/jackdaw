...
CFLAGS := -Wall -Wno-unused-command-line-argument -g -I$(SRC_DIR) -I$(GUI_SRC_DIR)  -I/usr/include/SDL2 `sdl2-config --libs --cflags` -lSDL2 -lSDL2_ttf -lpthread -lm -DINSTALL_DIR=\"`pwd`\" #-O3 #-fsanitize=address #-O3 # -O2 #-DLT_DEV_MODE=0
