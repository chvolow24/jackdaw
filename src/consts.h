...
#define INSTRUMENT_MIN_LATENCY_MS 1.0f
#define INSTRUMENT_MAX_LATENCY_MS 40.0f
#define INSTRUMENT_LATENCY_CURVATURE 2.0f
#define INSTRUMENT_LATENCY_DEFAULT_MS 11.0f
