...
static Page *add_reverb_page(Schroeder *sch, EffectChain *ec, TabView *tv)
{
    ...
    p.textbox_p.set_str = "Early reflections";
    page_add_el(page, EL_TEXTBOX, p, "", "er_lbl");

    p.textbox_p.set_str = "Dry / wet";
    page_add_el(page, EL_TEXTBOX, p, "", "wet_label");

    p.toggle_p.ep = &sch->early_reflections_ep;
    page_add_el(page, EL_TOGGLE, p, "er_tgl", "er_tgl");
